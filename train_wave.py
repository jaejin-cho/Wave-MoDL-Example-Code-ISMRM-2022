...
for epoch in range(N_epochs):
    ...
    for subj in range(num_train_subj):
        ...
        for batch in range(z_skip):
            ...
            del dat_wav, kdata_sub, wav_conj, img_uzp, img_zp, batch_img
            ...
            loss_t      =   model.train_on_batch([in_c,in_m,in_w,in_a],out_y)
    ...
    for subj in range(num_valid_subj):
        ...
        for batch in range(z_skip):
            ...
            loss_t      =   model.evaluate([in_c,in_m,in_w,in_a],out_y)
